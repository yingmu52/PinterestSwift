...
class NTTransition: NSObject, UIViewControllerAnimatedTransitioning {
  ...
  func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
    if presenting {
      animateTransitionPresent(transitionContext)
    } else {
      animateTransitionDismiss(transitionContext)
    }
  }
}

extension NTTransition {
  func animateTransitionPresent(_ transitionContext: UIViewControllerContextTransitioning) {
    guard
      ...
      let waterFallView = toViewController.collectionView,
      let pageView = fromViewController.collectionView
      else { return }
  ...
  func animateTransitionDismiss(_ transitionContext: UIViewControllerContextTransitioning) {
